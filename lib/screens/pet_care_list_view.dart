...
class PetCareListView extends StatefulWidget {
  const PetCareListView({Key? key}) : super(key: key);

  @override
  State<PetCareListView> createState() => _PetCareListViewState();
}

class _PetCareListViewState extends State<PetCareListView> {
  @override
