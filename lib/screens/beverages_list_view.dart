...
class BeveragesListView extends StatefulWidget {
  const BeveragesListView({Key? key}) : super(key: key);

  @override
  State<BeveragesListView> createState() => _BeveragesListViewState();
}

class _BeveragesListViewState extends State<BeveragesListView> {
  @override
