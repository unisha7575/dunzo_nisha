...
class InstantFoodView extends StatefulWidget {
  const InstantFoodView({Key? key}) : super(key: key);

  @override
  State<InstantFoodView> createState() => _InstantFoodViewState();
}

class _InstantFoodViewState extends State<InstantFoodView> {
  @override
