...
class FruitsViewScreen extends StatefulWidget {
  const FruitsViewScreen({Key? key}) : super(key: key);

  @override
  State<FruitsViewScreen> createState() => _FruitsViewScreenState();
}

class _FruitsViewScreenState extends State<FruitsViewScreen> {
  @override
