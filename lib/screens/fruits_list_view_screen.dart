...
class FruitsListViewScreen extends StatefulWidget {
  const FruitsListViewScreen({Key? key}) : super(key: key);

  @override
  State<FruitsListViewScreen> createState() => _FruitsListViewScreenState();
}

class _FruitsListViewScreenState extends State<FruitsListViewScreen> {
  @override
                ...
                child: ListView(children: [
                  ...
                  Column(
                    children: List.generate(fruits.length, (index) {
                      return InkWell(
                        onTap: (){
                          Navigator.of(context).pushNamed(MyRoutes. fruitsListViewScreen,arguments: {
                            "name":fruits[index].name ,
                            "image":fruits[index].image ,
                            "price":fruits[index].price ,
                            "weight":fruits[index].weight ,
                          });
                        },
                        child: Column(
                          children: [
