...
class CleaningHouseholdView extends StatefulWidget {
  const CleaningHouseholdView({Key? key}) : super(key: key);

  @override
  State<CleaningHouseholdView> createState() => _CleaningHouseholdViewState();
}

class _CleaningHouseholdViewState extends State<CleaningHouseholdView> {
  @override
