            ...
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Image.network("https://pigeon.com.pk/wp-content/uploads/2022/09/Artboard-7.png",
                              fit: BoxFit.fill,
                              height: 50,
                              width: 50,
                            ),
              ...
              Expanded(
                child: ListView(children: [
                  ...
                  Column(
                    children: List.generate(babyCare.length, (index) {
                      return InkWell(
                        onTap: (){
                          Navigator.of(context).pushNamed(MyRoutes. babyCare,arguments: {
                            "name":babyCare[index].name ,
                            "image":babyCare[index].image ,
                            "price":babyCare[index].price ,
                            "weight":babyCare[index].weight ,
                          });
                        },
                        child: Column(
                          children: [
