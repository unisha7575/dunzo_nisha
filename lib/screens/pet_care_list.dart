...
class PetCareList extends StatefulWidget {
  const PetCareList({Key? key}) : super(key: key);

  @override
  State<PetCareList> createState() => _PetCareListState();
}

class _PetCareListState extends State<PetCareList> {
  @override
            ...
            children: [
              ...
              Expanded(
                child: ListView(children: [
                  ...
                  Column(
                    children: List.generate(petCare.length, (index) {
                      return InkWell(
                        onTap: (){
                          Navigator.of(context).pushNamed(MyRoutes. petCareList,arguments: {
                            "name":petCare[index].name ,
                            "image":petCare[index].image ,
                            "price":petCare[index].price ,
                            "weight":petCare[index].weight ,
                          });
                        },
                        child: Column(
                          children: [
